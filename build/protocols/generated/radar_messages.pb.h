...
enum TrackStatus : int {
  ...
  COASTING = 3,
  DELETED = 4,
  TrackStatus_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  TrackStatus_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool TrackStatus_IsValid(int value);
constexpr TrackStatus TrackStatus_MIN = TRACK_STATUS_UNSPECIFIED;
constexpr TrackStatus TrackStatus_MAX = DELETED;
constexpr int TrackStatus_ARRAYSIZE = TrackStatus_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* TrackStatus_descriptor();
template<typename T>
inline const std::string& TrackStatus_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TrackStatus>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TrackStatus_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    TrackStatus_descriptor(), enum_t_value);
}
inline bool TrackStatus_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TrackStatus* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<TrackStatus>(
    TrackStatus_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::radar::messages::TrackStatus> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::radar::messages::TrackStatus>() {
  return ::radar::messages::TrackStatus_descriptor();
}
